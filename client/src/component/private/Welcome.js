...
const Welcome = () => {
    ...
    return (
        <div>
            <div class="container-fluid" style={{ textAlign: 'center', backgroundColor: '#311b92', color: 'white' }}>
                <br />
                <h3 class="display-8">WELCOME TO OFFICIAL DASHBOARD OF HOME 2 HOSPITAL</h3>
                <span style={{ backgroundColor: "#ffffff", color: "#311b92", padding: '8px', margin: '50px', borderRadius: '0.5rem' }} >Hello ! {userdata} </span>
                <br /><br />
            </div>
            ...
            >
                ...
                <div className="carousel-inner">
                    ...
                    <div className="carousel-item">
                        <img style={{ height: '300px', width: '100%' }} src={img4} className="d-block w-100" alt="..." />
                        <div className="carousel-caption d-none d-md-block">
                    ...
                    <div className="carousel-item">
                        <img style={{ height: '300px', width: '100%' }} src={img5} className="d-block w-100" alt="..." />
                        <div className="carousel-caption d-none d-md-block">
